...
\begin{figure}[h]
  \begin{centering}
    \includegraphics[width=.8\linewidth]{./png/siv_cst.png}
...
\subsubsection*{The exact origins of SIVcpz may not be identifiable}
...
\begin{figure}[h]
  \begin{centering}
  \includegraphics[width=0.65\textwidth]{./png/genetic_antigenic_distance.png}
