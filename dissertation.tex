...
\setcounter{page}{-1}
\abstract{%
RNA viruses --- including human pathogens such as influenza, dengue, and HIV --- have a high mutation rate, putting viral evolution and spread on comparable timescales.
This means that each viral consensus genome from an infected host represents one case in the course of an outbreak.
The history of viral evolution can be reconstructed using phylogenies.
Because each viral genome represents an infected host, information about viral population dynamics and host epidemic patterns is embedded within these phylogenies.
Phylodynamic methods leverage statistical models of population dynamics to extract these embedded epidemiological patterns from phylogenies.
...
First, I apply discrete trait analysis to lentiviral genomes to characterize the natural history of cross-species transmission (CST) among primates.
I find that there have been at least 13 instances of interlineage recombination among lentiviruses, and identify 14 novel, ancient CST events.
This demonstrates that lentiviruses have a far more extensive history of CST than previously recognized, emphasizing the importance of careful public health surveillance.
...
I identify at least 12 distinct antigenic phenotypes of dengue virus, in stark contrast to the prevalent null hypothesis that there are only four antigenic phenotypes of dengue; this presents an important consideration for vaccine design efforts.
I also find that antigenic novelty is a strong driver of dengue population turnover, although this is putatively driven by coarser serotype-level antigenic relationships.
Together, these findings demonstrate the power of phylodynamics and genomic epidemiology for broadening our understanding of how viruses evolve and move through populations.
This carries important ramifications for prioritizing public health surveillance measures.
}
...
\subsection{Uncovering the natural history of viral cross-species transmission}
