...
Because the serotypes are so clearly distinct, and because dengue evolves so slowly overall, it has long been assumed that all viruses within a serotype are antigenically uniform (\textit{i.e.}, they look about the same to the host immune system) \citep{twiddy2003inferring}.
...
Furthermore, the existance of large, ancient antigenic divergence between serotypes and smaller, more recent antigenic divergence between sub-serotype clades suggests that dengue antigenic evolution is gradual but ongoing.
