...
\subsection{Viral phylodynamics provides a framework for investigating host adaptation}
...
Returning to our previous example, the contrasting selective pressures presented by the host environments of dengue and influenza viruses are evident in the corresponding viral phylogenies.
...
For each dataset, these parameters are jointly fit to maximize $\Delta SSE$ (Table B1) via a sweep through parameter space.
