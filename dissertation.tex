...
Thus, each sampled case of an outbreak carries a unique viral genomic signature.
...
These viral evolutionary imperatives to replciate, transmit, and evade are interrelated, and may either compete or complement each other \citep{holmes2009evolution}.
...
This generally favors rapid diversification of external influenza proteins, although receptor binding must be maintained to preserve replicative fitness \citep{bush1999predicting}.
...
Maintaining this delicate balance generally favors conservation of most dengue proteins \citep{grubaugh2016genetic}.
...
Returning to our previous example, the contrasting selective pressures presented by the host environments of dengue and influenza viruses are evident in the corresponding viral phylogenies (Figure~\ref{dengue_vs_influenza}) \citep{volz2013viral}.
