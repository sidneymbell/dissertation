...
Such a richer catalog of dengue antigenic diversity would yield two major impacts.
...
I implemented a simple, deterministic model to directly quantify the extent to which antigenic novelty contributes to dengue viral fitness.
...
Thus, one way to incorporate seasonal bottlenecking into the current model would be to simply increase the value of $\beta$ (which scales how strongly antigenic fitness influences predicted frequency change) for timepoints when the dengue population is expected to be lower.
